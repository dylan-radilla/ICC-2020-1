...
public class SVG {
    ...
    public void agregarLinea(Linea linea) {
        double a =linea.getP1().getX();
        double b =linea.getP1().getY();
        double c =linea.getP2().getX();
        double d =linea.getP2().getY();
        
        String s = "<line x1=\""+a+"\" y1=\""+b+ "\" x2=\""+c+"\" y2=\""+d+"\" style=\"stroke: black; stroke-width: 1; fill: none\"/>";
        concatenar (s);
    ...
    public void agregarTriangulo(Triangulo triangulo) {
        double a = triangulo.getA().getX();
        double b = triangulo.getA().getY();
        double c = triangulo.getB().getX();
        double d = triangulo.getB().getY();
        double f = triangulo.getC().getX();
        double g = triangulo.getC().getY();

        String s = "<line x1=\""+a+"\" y1=\""+b+ "\" x2=\""+c+"\" y2=\""+d+"\" style=\"stroke: black; stroke-width: 1; fill: none\"/>";
        concatenar (s);
        String t = "<line x1=\""+c+"\" y1=\""+d+ "\" x2=\""+f+"\" y2=\""+g+"\" style=\"stroke: black; stroke-width: 1; fill: none\"/>";
        concatenar (t);
        String u = "<line x1=\""+a+"\" y1=\""+b+ "\" x2=\""+f+"\" y2=\""+g+"\" style=\"stroke: black; stroke-width: 1; fill: none\"/>";
        concatenar (u);
    }
